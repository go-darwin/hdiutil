...
func (c CreateSize) sizeFlag() []string { return intFlag(int(c), "size") }

// CreateSectors specify the size of the image file in 512-byte sectors.
type CreateSectors int

func (c CreateSectors) sizeFlag() []string { return intFlag(int(c), "sectors") }

// CreateMegabytes specify the size of the image file in megabytes (1024*1024 bytes).
type CreateMegabytes int

func (c CreateMegabytes) sizeFlag() []string { return intFlag(int(c), "megabytes") }
...
func (c CreateSrcfolder) sizeFlag() []string { return stringFlag(string(c), "srcfolder") }

// CreateSrcdir is a synonym to CreateSrcfolder.
type CreateSrcdir CreateSrcfolder

func (c CreateSrcdir) sizeFlag() []string { return stringFlag(string(c), "srcdir") }
...
func (c CreateSrcdevice) sizeFlag() []string { return stringFlag(string(c), "srcdevice") }
...
func (c CreateAlign) createFlag() []string { return intFlag(int(c), "align") }
...
func (c createType) createFlag() []string { return stringFlag(c.String(), "type") }
...
func (c createFS) createFlag() []string { return stringFlag(c.String(), "fs") }
...
func (c CreateVolname) createFlag() []string { return stringFlag(string(c), "volname") }
...
func (c CreateUID) createFlag() []string { return intFlag(int(c), "uid") }

// CreateGID the root of the newly-created volume will be owned by the given numeric group id. 99 maps to `unknown'.
type CreateGID int

func (c CreateGID) createFlag() []string { return intFlag(int(c), "gid") }
...
func (c CreateMode) createFlag() []string { return stringFlag(string(c), "mode") }

type createAutostretch bool

func (c createAutostretch) createFlag() []string { return boolNoFlag(bool(c), "autostretch") }
...
func (c CreateStretch) createFlag() []string { return intFlag(int(c), "stretch") }
...
func (c CreateFSArgs) createFlag() []string { return stringSliceFlag(c, "fsargs") }
...
func (c CreateLibrary) createFlag() []string { return stringFlag(string(c), "library") }
...
func (c CreatePartitionType) createFlag() []string { return stringFlag(string(c), "partitionType") }

type createOV bool

func (c createOV) createFlag() []string { return boolFlag(bool(c), "ov") }

type createAttach bool

func (c createAttach) createFlag() []string { return boolFlag(bool(c), "attach") }
...
func (c CreateFormat) createFlag() []string { return stringFlag(string(c), "format") }
...
func (c CreateSegmentSize) createFlag() []string { return intFlag(int(c), "segmentSize") }

type createCrossdev bool

func (c createCrossdev) createFlag() []string { return boolNoFlag(bool(c), "crossdev") }

type createScrub bool

func (c createScrub) createFlag() []string { return boolNoFlag(bool(c), "scrub") }

type createAnyowners bool

func (c createAnyowners) createFlag() []string { return boolNoFlag(bool(c), "anyowners") }

type createSkipunreadable bool

func (c createSkipunreadable) createFlag() []string { return boolFlag(bool(c), "skipunreadable") }

type createAtomic bool

func (c createAtomic) createFlag() []string { return boolFlag(bool(c), "atomic") }
...
func (c CreateCopyuid) createFlag() []string { return stringFlag(string(c), "copyuid") }
